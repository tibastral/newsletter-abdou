class PartiesController < ApplicationController
  ...
  # GET /parties.xml
  def index
    @parties = Party.find_all_by_newsletter_id(params[:newsletter_id])
  ...
  # GET /parties/new.xml
  def new
    @party = Party.new(:newsletter_id => params[:newsletter_id])
  ...
  def create
    ...
    respond_to do |format|
      if @party.save
        ...
        @newsletter.parties << @party
        format.html { redirect_to(newsletter_party_path(@newsletter, @party)) }
